The enclosed Notebook.Rmd file contains all of the R code used to generate Figures 1, 2G–H, 3, 4, 6, and 7, and Supplementary Figures 5 and 6 from the manuscript by Phipps et al. entitled, "Collective interactions augment influenza A virus replication in a host-dependent manner."
